...
def test_strict_mode_accepts_real_password() -> None:
    ...
    """
    # Random-looking 26-char fake used only to exercise the "real
    # password" acceptance branch of the gate. Not a credential.
    real_password = "kQXf8vN3p2RmHcLwYj7tBdAeUg"  # gitleaks:allow
    result = _helm_template(
        "strictPasswords=true",
