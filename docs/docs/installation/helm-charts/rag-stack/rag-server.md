...
helm install rag-server oci://ghcr.io/cnoe-io/charts/rag-server --version 0.6.0

# Upgrade an existing release
helm upgrade rag-server oci://ghcr.io/cnoe-io/charts/rag-server --version 0.6.0
```
...
helm show values oci://ghcr.io/cnoe-io/charts/rag-server --version 0.6.0
```
