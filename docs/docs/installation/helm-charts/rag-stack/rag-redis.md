...
helm install rag-redis oci://ghcr.io/cnoe-io/charts/rag-redis --version 0.6.0

# Upgrade an existing release
helm upgrade rag-redis oci://ghcr.io/cnoe-io/charts/rag-redis --version 0.6.0
```
...
helm show values oci://ghcr.io/cnoe-io/charts/rag-redis --version 0.6.0
```
