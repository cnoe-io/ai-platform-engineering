...
| rag-ingestors.webloader.enabled | bool | `true` |  |
| rag-ingestors.webloader.env.WEBLOADER_MAX_INGESTION_TASKS | string | `"5"` |  |
| rag-ingestors.webloader.envFrom | list | `[]` |  |
| rag-ingestors.webloader.initDelaySeconds | int | `0` |  |
| rag-ingestors.webloader.logLevel | string | `"INFO"` |  |
| rag-ingestors.webloader.name | string | `"webloader"` |  |
| rag-ingestors.webloader.resources.limits.cpu | string | `"500m"` |  |
| rag-ingestors.webloader.resources.limits.ephemeral-storage | string | `"1Gi"` |  |
| rag-ingestors.webloader.resources.limits.memory | string | `"1Gi"` |  |
| rag-ingestors.webloader.resources.requests.cpu | string | `"100m"` |  |
| rag-ingestors.webloader.resources.requests.ephemeral-storage | string | `"256Mi"` |  |
| rag-ingestors.webloader.resources.requests.memory | string | `"256Mi"` |  |
| rag-ingestors.webloader.syncInterval | int | `86400` |  |
| rag-ingestors.webloader.type | string | `"webloader"` |  |
