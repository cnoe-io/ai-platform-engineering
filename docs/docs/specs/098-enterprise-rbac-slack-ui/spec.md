...
- Agent Gateway uses **[CEL](https://agentgateway.dev/docs/reference/cel/)** as its policy language; this is an AG upstream decision, not a **098** prescriptive choice (**Sessions 2026-03-29**, **2026-03-31**).
