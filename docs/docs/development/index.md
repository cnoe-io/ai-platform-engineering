...
- **[Contributing Guide](../contributing/index.md)** - Choose the right-sized issue, design note, and pull request
...
5. **[Add an MCP server](./creating-mcp-server)** - Connect an agent to an external API
