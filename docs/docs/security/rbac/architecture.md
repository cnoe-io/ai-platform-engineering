...
> for the full demolition rationale, and [`scripts/cleanup-team-keycloak-scopes.sh`](https://github.com/cisco-eti/ai-platform-engineering/blob/main/scripts/cleanup-team-keycloak-scopes.sh)
> for the one-time operator cleanup that drops legacy `team-*` scopes
> from upgraded realms.
