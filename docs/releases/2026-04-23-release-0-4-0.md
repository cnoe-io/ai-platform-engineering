...
> Released: 2026-04-23
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.4.0`
...
- **Slack bot AG-UI rewrite** — typing indicators with live thoughts, todo-aware streaming, subagent suppression ([#1259](https://github.com/caipe-io/ai-platform-engineering/pull/1259))
...
- Bearer token auth added for service accounts (Slack bot) ([#1259](https://github.com/caipe-io/ai-platform-engineering/pull/1259))
...
- `PATCH /api/chat/conversations/[id]/metadata` with MongoDB dot-notation `$set` ([#1259](https://github.com/caipe-io/ai-platform-engineering/pull/1259))
...
- Metrics endpoint exposed ([#1259](https://github.com/caipe-io/ai-platform-engineering/pull/1259))
...
- New theme: System (follow OS theme) ([#1259](https://github.com/caipe-io/ai-platform-engineering/pull/1259))

## Bug Fixes

- **slack**: add `escalation_policy` field to VictorOps escalation config; fix humble followup prompt when agent has no record of prior reply ([#1277](https://github.com/caipe-io/ai-platform-engineering/pull/1277))
- **admin**: fix feedback dedup by `(permalink, user_email)` instead of permalink-only; fix Slack feedback upsert key to `(message_id, user_id)`; fix top-user linkage ([#1273](https://github.com/caipe-io/ai-platform-engineering/pull/1273))
