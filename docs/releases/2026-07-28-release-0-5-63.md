...
> Released: 2026-07-28
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.5.63`
...
- **credentials**: the secret sharing panel now loads share candidates from the caller-scoped teams endpoint instead of an admin-only one, so regular users see the teams they actually belong to instead of an empty picker. ([#2312](https://github.com/caipe-io/ai-platform-engineering/pull/2312))
