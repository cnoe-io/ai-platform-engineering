...
> Released: 2026-07-02
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.5.35`
...
([#2106](https://github.com/caipe-io/ai-platform-engineering/pull/2106))

### OpenFGA Prometheus metrics port exposed

The OpenFGA deployment and service now expose the built-in Prometheus metrics port (2112), which OpenFGA serves by default. The new dedicated `servicemonitor-openfga.yaml` targets this port instead of the API port (8080). ([#2106](https://github.com/caipe-io/ai-platform-engineering/pull/2106))
