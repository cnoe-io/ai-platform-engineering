...
> Released: 2026-05-29
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.5.3`
...
- **ui**: recover the AgentGateway MCP route path from the live `pathPrefix` shape so discovered routes match the proxy config ([#1629](https://github.com/caipe-io/ai-platform-engineering/pull/1629))
- **helm**: wire the CAIPE UI to the AgentGateway proxy for CRD-free MCP discovery ([#1629](https://github.com/caipe-io/ai-platform-engineering/pull/1629))
- **helm**: fix whitespace trimming that caused YAML parse errors in deployment env blocks and compute release-name service URL defaults in templates ([#1612](https://github.com/caipe-io/ai-platform-engineering/pull/1612))
