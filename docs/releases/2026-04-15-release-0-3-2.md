---
slug: release-0.3.2
title: "Release 0.3.2 — Skills Gateway, Dynamic Agents, MongoDB Migrations"
date: 2026-04-15
...
Release 0.3.2 is a significant milestone introducing the Skills Gateway UI, Dynamic Agents timeline with human-in-the-loop cancellation, and a new RAG ingestor for Jira. It includes several **breaking MongoDB schema changes** requiring migration scripts before upgrading from 0.2.41.

<!-- truncate -->

---

## Upgrade Guide: 0.2.41 → 0.3.2
...
agent-slack:
  mcp:
    image:
      # OLD: ghcr.io/caipe-io/mcp-slack
...
| Slack MCP image change | Rolling back requires reverting to `ghcr.io/caipe-io/mcp-slack` on port 8000 | Update Helm values on rollback |
