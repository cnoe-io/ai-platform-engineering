...
> Released: 2026-04-27
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.4.2`
...
- **skills**: fix `caipe-skills.py` 404 — file was missing from the `skills-bootstrap` ConfigMap so the helper stub was always served; add auth fallback; simplify gateway UI ([#1286](https://github.com/caipe-io/ai-platform-engineering/pull/1286))
- **docs**: escape bare `<` in `plan.md` to fix MDX build error ([#1285](https://github.com/caipe-io/ai-platform-engineering/pull/1285))
