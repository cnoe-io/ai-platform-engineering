---
slug: release-0.4.3
title: "Release 0.4.3 — Slack Config and Integrations Docs"
date: 2026-04-27
...
> Released: 2026-04-27
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.4.3`
...
### Documentation
- **Integrations docs**: add Backstage plugin, Webex bot, and CAIPE CLI setup guides ([#1297](https://github.com/caipe-io/ai-platform-engineering/pull/1297))

## Bug Fixes

- **setup**: guard empty-array expansions (`${arr[@]}`) for bash 3.2 compatibility — prevents `unbound variable` errors on macOS when no kind clusters or kubectl contexts exist ([#1304](https://github.com/caipe-io/ai-platform-engineering/pull/1304))
- **docs**: responsive iframe for demo video; fix sidebar links ([#1292](https://github.com/caipe-io/ai-platform-engineering/pull/1292))
...
If you already migrated your `botConfig` as part of the 0.4.0 upgrade, no further action is required. ([#1288](https://github.com/caipe-io/ai-platform-engineering/pull/1288))
