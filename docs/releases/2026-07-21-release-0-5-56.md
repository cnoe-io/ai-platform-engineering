...
> Released: 2026-07-21
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.5.56`
...
([#2209](https://github.com/caipe-io/ai-platform-engineering/pull/2209))
...
([#2237](https://github.com/caipe-io/ai-platform-engineering/pull/2237))
...
- Scoped down the GitHub App token used by the prebuild artifact-comment CI workflow to only the permissions the reconciler script actually needs (flagged by static analysis as over-broad). ([#2250](https://github.com/caipe-io/ai-platform-engineering/pull/2250))
