...
> Released: 2026-05-05
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.4.7`
...
- **AI Assist** — generate or refine skill content with AI assistance ([#1327](https://github.com/caipe-io/ai-platform-engineering/pull/1327))

### Dynamic Agent Editor
- **Unsaved-changes guard** — confirm dialog shown before navigating away from a dirty agent editor; guards back-button, tab switches, and top-level header links ([#1328](https://github.com/caipe-io/ai-platform-engineering/pull/1328))
