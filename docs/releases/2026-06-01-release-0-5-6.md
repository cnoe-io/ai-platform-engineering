...
> Released: 2026-06-01
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.5.6`
...
- **keycloak**: restore `manage-realm` to the `caipe-platform` service account desired roles ([#1678](https://github.com/caipe-io/ai-platform-engineering/pull/1678))
