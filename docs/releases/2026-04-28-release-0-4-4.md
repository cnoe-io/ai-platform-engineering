...
> Released: 2026-04-28
> Chart: `oci://ghcr.io/caipe-io/charts/ai-platform-engineering:0.4.4`
...
- **Agent editor UX** — subagent fixes and UI polish for the agent configuration editor ([#1299](https://github.com/caipe-io/ai-platform-engineering/pull/1299))
