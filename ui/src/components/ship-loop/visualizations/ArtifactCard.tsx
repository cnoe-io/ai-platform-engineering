...
import type { ShipLoopArtifact } from "@/types/ship-loop";

const KIND_ICON: Record<ShipLoopArtifact["kind"], LucideIcon> = {
  epic: GitBranch,
  subtask: GitBranch,
 ...
 */
function inferActor(a: ShipLoopArtifact): "agent" | "human" {
