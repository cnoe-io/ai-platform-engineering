...
import { Send, Square, User, Bot, Sparkles, Copy, Check, Loader2, ChevronDown, ChevronUp, ArrowDown, ArrowLeft, RotateCcw, Video, Activity, MessageSquare, Clock, ShieldCheck } from "lucide-react";
