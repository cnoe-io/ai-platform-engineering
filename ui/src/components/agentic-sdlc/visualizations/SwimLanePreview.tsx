...
export function SwimLanePreview({ className }: SwimLanePreviewProps) {
  return (
    <div
      ...
      role="img"
      aria-label="Animated preview of the Agentic SDLC kanban visualization with three swim lanes: Implement, Review, Deploy, and agent and human task cards drifting across each lane"
    >
