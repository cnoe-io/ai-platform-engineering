/**
 * GET /api/ship-loop/repos/{owner}/{repo}/epics/{epicId}/events
 ...
 *     withShipLoopGate already 404s on entry; we don't poll the
...
const SSE_HEADERS: HeadersInit = {
  ...
  // until they see a content length. Mirrors the existing AG-UI
