...
async function createIndexes(db: Db) {
  ...
  await Promise.all([
    ...
    safeCreateIndex(db, 'agentic_app_packages', { 'manifest.id': 1 }, { unique: true }),
    ...
    safeCreateIndex(db, 'agentic_app_packages', { source: 1 }),
    safeCreateIndex(db, 'agentic_app_installations', { appId: 1 }, { unique: true }),
    safeCreateIndex(db, 'agentic_app_installations', { packageId: 1 }),
    safeCreateIndex(db, 'agentic_app_installations', { enabled: 1 }),
    safeCreateIndex(db, 'agentic_app_installations', { installed: 1, enabled: 1, visible: 1 }),
    safeCreateIndex(
      db,
      'agentic_app_installations',
      { 'routeOwnership.normalizedMountPath': 1 },
      { unique: true },
    ),
    ...
    safeCreateIndex(db, 'agentic_app_events', { correlationId: 1 }),
    safeCreateIndex(db, 'agentic_app_events', { decisionId: 1 }),
    safeCreateIndex(db, 'agentic_app_events', { type: 1, createdAt: -1 }),
    safeCreateIndex(db, 'agentic_app_pdp_decisions', { decisionId: 1 }, { unique: true }),
    safeCreateIndex(db, 'agentic_app_pdp_decisions', { appId: 1, issuedAt: -1 }),
    safeCreateIndex(db, 'agentic_app_pdp_decisions', { 'subject.hash': 1, issuedAt: -1 }),
    safeCreateIndex(db, 'agentic_app_pdp_decisions', { correlationId: 1 }),
    safeCreateIndex(db, 'agentic_app_token_grants', { jti: 1 }, { unique: true }),
    safeCreateIndex(db, 'agentic_app_token_grants', { appId: 1, issuedAt: -1 }),
    safeCreateIndex(db, 'agentic_app_token_grants', { decisionId: 1 }),
    safeCreateIndex(db, 'agentic_app_webhook_deliveries', { deliveryId: 1 }, { unique: true }),
    safeCreateIndex(
      db,
      'agentic_app_webhook_deliveries',
      { appId: 1, provider: 1, channel: 1, receivedAt: -1 },
    ),
    safeCreateIndex(db, 'agentic_app_webhook_deliveries', { providerDeliveryId: 1, provider: 1 }),
    safeCreateIndex(db, 'agentic_app_webhook_deliveries', { correlationId: 1 }),
