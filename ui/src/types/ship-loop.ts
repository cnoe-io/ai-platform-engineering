/**
 * Shared TypeScript types for the Agentic SDLC Ship Loop feature.
 *
...
export const SHIP_LOOP_STAGES: ShipLoopStage[] = [
  "specify",
  "plan",
  "tasks",
  "implement",
 ...
 */
export const DEFAULT_AGENT_LABEL_TO_STAGE: Record<string, ShipLoopStage> = {
...
export interface OnboardedRepo {
  ...
  label_to_stage_overrides: Record<string, ShipLoopStage>;
...
export interface ShipLoopEvent {
  _id?: ObjectId;
  repo_id: string;
  source: "github" | "ui";
...
// ---------------------------------------------------------------------------
// ShipLoopArtifact (derived state)
// ---------------------------------------------------------------------------
...
export interface ShipLoopArtifact {
  _id?: ObjectId;
  repo_id: string;
...
export interface VelocityMetric {
  ...
  epics_merged: number;
  median_time_in_stage_seconds: Partial<Record<ShipLoopStage, number>>;
...
export const SHIP_LOOP_COLLECTIONS = {
