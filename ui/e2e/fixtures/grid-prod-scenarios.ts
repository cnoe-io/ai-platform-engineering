...
export const gridProdWorkflowScenarios: GridProdScenario[] = [
  ...
  },
  {
    ...
    livePrompt: [
      ...
      "Use key name grid-prod-playwright-llm-{{run_id}}, key type individual, model gpt-4o-mini, owner eti-sre-cicd.gen, purpose GRID prod Playwright smoke validation, and a one-day TTL if the workflow asks for defaults.",
    ].join("\n"),
    hitlFormValues: {
