...
{{- $globalSecretName := dig "scheduler" "serviceTokenSecretName" "" (.Values.global | default dict) -}}
{{- if .Values.serviceToken.existingSecret -}}
{{- .Values.serviceToken.existingSecret -}}
{{- else if $globalSecretName -}}
{{- $globalSecretName -}}
{{- else -}}
...
{{- define "scheduler.serviceTokenSecretKey" -}}
{{- $globalSecretKey := dig "scheduler" "serviceTokenSecretKey" "" (.Values.global | default dict) -}}
{{- if $globalSecretKey -}}
{{- $globalSecretKey -}}
{{- else -}}
{{- .Values.serviceToken.existingSecretKey | default "token" -}}
{{- end -}}
{{- end -}}
