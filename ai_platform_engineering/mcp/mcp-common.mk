...
#   AGENT_NAME - The name of your agent (e.g., argocd, jira, komodor)
#
# Optional variables:
#   MCP_ENTRYPOINT - The server entrypoint module (default: server.py)
...
help: ## Show this help message
	...
	@echo "  MCP_ENTRYPOINT=$(MCP_ENTRYPOINT)"
