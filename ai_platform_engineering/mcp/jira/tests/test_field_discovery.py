...
import pytest
from utils.field_discovery import FieldDiscovery, get_field_discovery
...
class TestGetEpicLinkField:
    ...
    async def test_epic_link_not_found(self, monkeypatch):
        ...
        monkeypatch.setattr(api.client, "make_api_request", mock_request_no_epic)
        monkeypatch.setattr(utils.field_discovery, "make_api_request", mock_request_no_epic)
