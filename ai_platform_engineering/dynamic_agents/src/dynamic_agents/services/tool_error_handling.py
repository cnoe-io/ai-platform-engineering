...
ai_platform_engineering/utils/deepagents_custom/tool_error_handling.py
kept in sync manually because dynamic_agents has its own venv and cannot
import from the parent ai_platform_engineering package.
"""
