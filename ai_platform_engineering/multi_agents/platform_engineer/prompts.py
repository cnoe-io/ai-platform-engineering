...
def generate_system_prompt(agents: Dict[str, Any]):
  ...
  for agent_key, agent_card in agents.items():
    ...
    # Tool instruction generation logging removed to reduce log noise
...
"""
  ...
  # System prompt template logging removed to reduce log noise
...
# System prompt logging removed to reduce log noise
# logger.info("="*50)
