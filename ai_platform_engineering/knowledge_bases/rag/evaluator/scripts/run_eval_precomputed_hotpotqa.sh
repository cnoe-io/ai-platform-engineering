...
# Override configuration variables for HOTPOTQA (sourced from .env)
export CAIPE_DATASOURCE_ID="${CAIPE_DATASOURCE_ID:-${HOTPOTQA_CAIPE_DATASOURCE_ID}}"
export QUESTIONS_PATH="${QUESTIONS_PATH:-${HOTPOTQA_QUESTIONS_PATH}}"
export DATASET_NAME="${DATASET_NAME:-${HOTPOTQA_DATASET_NAME}}"
