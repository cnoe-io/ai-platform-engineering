...
class TestMatchResult:
  ...
  def test_match_result_creation(self):
    ...
    result = MatchResult(is_match=True, match_type=ValueMatchType.EXACT, quality=1.0)
  ...
  def test_match_result_no_match(self):
    ...
    result = MatchResult(is_match=False, match_type=ValueMatchType.NONE, quality=0.0)
...
class TestHeuristicsProcessorMatching:
  ...
  def processor(self):
    ...
    graph_db = Mock()
    rc_manager = Mock()
    return HeuristicsProcessor(graph_db=graph_db, rc_manager=rc_manager)
...
class TestHeuristicsProcessorHelpers:
  ...
  def test_calculate_deep_match_quality_unique_mapping(self, processor):
    ...
    property_mappings = [PropertyMapping(entity_a_property="user_id", entity_b_idkey_property="id", match_type=ValueMatchType.EXACT, value_match_quality=1.0)]

    quality = processor.calculate_deep_match_quality(bm25_score=10.0, property_mappings=property_mappings, identity_key={"id": "123"}, num_valid_mappings=1)
  ...
  def test_calculate_deep_match_quality_ambiguous(self, processor):
    ...
    property_mappings = [PropertyMapping(entity_a_property="user_id", entity_b_idkey_property="id", match_type=ValueMatchType.PREFIX, value_match_quality=0.8)]
...
class TestHeuristicsProcessorStatistics:
  ...
  def test_initial_stats(self):
    ...
    graph_db = Mock()
    rc_manager = Mock()
    processor = HeuristicsProcessor(graph_db=graph_db, rc_manager=rc_manager)
