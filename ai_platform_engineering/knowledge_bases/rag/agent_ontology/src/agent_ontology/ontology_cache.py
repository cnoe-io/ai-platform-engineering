...
class OntologyCache:
  ...
  def get_stats(self) -> dict:
    ...
    return {"total_entity_types": len(self.entity_types), "sub_entity_types": len(self.sub_entity_types), "sub_entity_candidates": len(self.sub_entity_candidates), "total_unique_properties": sum(len(props) for props in self.entity_properties.values()), "entity_types": list(self.entity_types)}
