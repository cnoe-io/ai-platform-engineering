...
class TestOntologyEndToEnd:
  ...
  async def get_relation_manager(self) -> RelationCandidateManager:
    ...
    relation_manager = RelationCandidateManager(self.data_graph_db, self.ontology_graph_db, ontology_version_id, "test_agent")
  ...
  async def test_relation_management_endpoints(self):
    ...
    response = requests.post(f"{self.base_url}/v1/graph/ontology/agent/relation/accept/{accepted_relation_id}", params={"relation_name": "test_relation"}, timeout=30)
    ...
    # Undo the evaluation
    response = requests.post(f"{self.base_url}/v1/graph/ontology/agent/relation/undo_evaluation/{accepted_relation_id}", timeout=30)
    ...
    # Reject the relation
    response = requests.post(f"{self.base_url}/v1/graph/ontology/agent/relation/reject/{accepted_relation_id}", timeout=30)
    ...
    # Accept the relation
    response = requests.post(f"{self.base_url}/v1/graph/ontology/agent/relation/accept/{accepted_relation_id}", params={"relation_name": "test_relation_final"}, timeout=30)
  ...
  async def test_reject_unsure_relation(self):
    ...
    response = requests.post(f"{self.base_url}/v1/graph/ontology/agent/relation/undo_evaluation/{unsure_relation_id}", timeout=30)
    ...
    response = requests.post(f"{self.base_url}/v1/graph/ontology/agent/relation/reject/{unsure_relation_id}", timeout=30)
