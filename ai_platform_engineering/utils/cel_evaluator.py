...
Canonical copy for the monorepo. The RAG server and dynamic-agents service keep
synchronized duplicates under their own ``src/`` trees to avoid depending on this
package’s pinned LangChain / a2a-sdk versions.

Standard context shape:
  user.roles, user.teams, user.email,
