...
def configure_logging():
    ...
    and quiet noisy streaming/SSE loggers.
    ...
    # Reduce noise from SSE streaming loggers while keeping important warnings
    # visible. These loggers can be verbose during normal operation; set to
    # WARNING instead of ERROR to still see important warnings.
    for log_name in ["sse_starlette.sse"]:
        sse_logger = logging.getLogger(log_name)
