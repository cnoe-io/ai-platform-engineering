...
def _stub_modules():
    stubs = {
        "agntcy_app_sdk": types.ModuleType("agntcy_app_sdk"),
        "agntcy_app_sdk.factory": types.ModuleType("agntcy_app_sdk.factory"),
    ...
    class _FakeFactory:
        ...
        def create_bridge(self, *a, **kw): ...

    stubs["agntcy_app_sdk.factory"].AgntcyFactory = _FakeFactory
