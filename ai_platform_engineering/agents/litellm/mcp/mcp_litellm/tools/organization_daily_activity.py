"""Tools for /organization/daily/activity operations"""
...
async def get_organization_get(
  ...
  param_exclude_organization_ids: str | None = None,
) -> Any:
  """
  ...
  Args:
      ...
      param_organization_ids (str): OpenAPI parameter corresponding to 'param_organization_ids'
      ...
      param_exclude_organization_ids (str): OpenAPI parameter corresponding to 'param_exclude_organization_ids'
  ...
  """
  logger.debug("Making GET request to /organization/daily/activity")
  ...
  if param_exclude_organization_ids is not None:
    params["exclude_organization_ids"] = (
      str(param_exclude_organization_ids).lower() if isinstance(param_exclude_organization_ids, bool) else param_exclude_organization_ids
    )

  flat_body = {}
  data = assemble_nested_body(flat_body)

  success, response = await make_api_request("/organization/daily/activity", method="GET", params=params, data=data)
