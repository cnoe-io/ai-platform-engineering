"""Tools for /cache/settings operations"""
...
async def get_cache_get() -> Any:
  ...
  """
  logger.debug("Making GET request to /cache/settings")
  ...
  success, response = await make_api_request("/cache/settings", method="GET", params=params, data=data)
