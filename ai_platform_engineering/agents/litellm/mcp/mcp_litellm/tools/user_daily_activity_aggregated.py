"""Tools for /user/daily/activity/aggregated operations"""
...
async def get_get_user_get(
  ...
  """
  logger.debug("Making GET request to /user/daily/activity/aggregated")
  ...
  success, response = await make_api_request("/user/daily/activity/aggregated", method="GET", params=params, data=data)
