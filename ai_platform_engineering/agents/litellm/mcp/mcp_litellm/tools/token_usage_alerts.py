  ...
  *,
  ...
  return "\n".join(
    [
      ...
      "",
      f"`{recipient}` has used **{usage_percent}%** of the configured LiteLLM token limit.",
      "",
      "**Usage**",
      ...
      "",
      "**Action**",
      "Please review current usage or request a higher token limit from platform team before more requests are affected.",
    ]
  )
