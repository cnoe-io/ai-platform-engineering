...
from agent_azuredevops.protocol_bindings.a2a_server.agent_executor import AzureDevOpsAgentExecutor
from agent_azuredevops.agentcard import create_agent_card
...
async def async_main(host: str, port: int):
    ...
    request_handler = DefaultRequestHandler(
      agent_executor=AzureDevOpsAgentExecutor(),
