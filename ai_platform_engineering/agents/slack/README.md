...
- 🏭 **OSS MCP Server:** Uses the [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) — a Go-based Slack MCP server supporting multiple auth modes, transports (stdio/SSE/HTTP), and stealth mode.
...
- 🔗 Connects to Slack via the OSS [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)
...
## MCP Server Configuration (korotovsky/slack-mcp-server)
MCP_HOST=localhost
MCP_PORT=3001
