...
from agent_istio.protocol_bindings.a2a_server.agent_executor import IstioAgentExecutor
from agent_istio.agentcard import create_agent_card
...
async def async_main(host: str, port: int):
    ...
    request_handler = DefaultRequestHandler(
      agent_executor=IstioAgentExecutor(),
