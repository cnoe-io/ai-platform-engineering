...
OVERTHINK_BOILERPLATE = (
    ...
    " tokens below to opt out of replying — the bot suppresses them, so never reply with"
    " empty text.\n"
    "\n"
    ...
    " The bot will suppress this entire response — the draft is preserved in the"
    " conversation history so a follow-up can build on it.\n"
    "\n"
