...
class TestScoringUtility:
  ...
  def test_permalink_links_to_message(self, mock_post, monkeypatch):
    ...
    assert payload["slackPermalink"] == ("https://slack.test/archives/C02AVQ61E3H/p1775145010565959?thread_ts=1775145001.897279&cid=C02AVQ61E3H")
  ...
  def test_invalid_message_ts_falls_back_to_thread(self, mock_post, monkeypatch):
    ...
    assert payload["slackPermalink"] == ("https://slack.test/archives/C02AVQ61E3H/p1775145001897279")
