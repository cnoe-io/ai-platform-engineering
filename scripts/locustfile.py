"""
Locust benchmark — caipe-ui API latency before/after audit-service switch.
...
with audit-service enabled to see the improvement.
...
After (this PR — audit-service):
    AUDIT_LOG_BACKEND=service AUDIT_SERVICE_URL=http://audit-service:8010 \\
    NEXTAUTH_SECRET=<secret> \\
      locust -f scripts/locustfile.py --headless \\
             -u 20 -r 5 --run-time 60s \\
             --host http://localhost:3000 \\
